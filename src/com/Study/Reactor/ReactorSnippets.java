...
public class ReactorSnippets {
    ...
    @Test
    public void helloWorldShort(){
        Flux<String> helloworld = Mono.just("Hello")
                .concatWith(Mono.just("World"));
        helloworld.subscribe(System.out::println);
    }

    @Test
    public void helloWorldshortCircuit(){
    ...
    public void firstEmitting(){
        Mono<String> a = Mono.just("oops I am late").delaySubscription(Duration.ofMillis(450));
